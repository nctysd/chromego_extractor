...
if __name__ == "__main__":
    ...
    # # 写入clash meta配置
    write_clash_meta_profile("./templates/clash_meta.yaml", "./cy/clash_meta.yaml", extracted_proxies)
    write_clash_meta_profile("./templates/clash_meta_warp.yaml", "./cy/clash_meta_warp.yaml", extracted_proxies)

    # 写入代理urls
    write_proxy_urls_file("./cy/proxy_urls.txt", extracted_proxies)
    
    write_base64_file("./cy/base64.txt", "./cy/proxy_urls.txt")
